...
namespace Fragment.NetSlum.Persistence.Migrations
{
    ...
    [Migration("20251107181358_AccountInfoUpdate")]
    partial class AccountInfoUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fragment.NetSlum.Persistence.Entities.HomeLandEntity", b =>
                {
                    b.Property<uint>("HomeLandId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int unsigned")
                        .HasColumnName("home_land_id");

                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<uint>("HomeLandId"));

                    b.Property<uint>("ClearCnt")
                        .HasColumnType("int unsigned")
                    ...
                    b.Property<byte>("Countdown")
                        .HasColumnType("tinyint unsigned")
                        .HasColumnName("countdown");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("created_at");

                    b.Property<byte>("HeartbeatMode")
                        .HasColumnType("tinyint unsigned")
                        .HasColumnName("heartbeat_mode");

                    b.Property<string>("HomeLandName")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("home_land_name")
                        .UseCollation("cp932_japanese_ci");

                    MySqlPropertyBuilderExtensions.HasCharSet(b.Property<string>("HomeLandName"), "cp932");

                    b.Property<DateTime>("LastUpdate")
                        .HasColumnType("datetime(6)")
                        .HasColumnName("last_update");

                    b.Property<ushort>("Latency")
                        .HasColumnType("smallint unsigned")
                        .HasColumnName("latency");

                    b.Property<uint>("LocalIp")
                        .HasColumnType("int unsigned")
                        .HasColumnName("local_ip");
                    ...
                    b.Property<byte>("MaxPlayerCnt")
                        .HasColumnType("tinyint unsigned")
                        .HasColumnName("max_player_cnt");
                    ...
                    MySqlPropertyBuilderExtensions.HasCharSet(b.Property<string>("Password"), "cp932");

                    b.Property<int>("PlayerAccountId")
                        .HasColumnType("int")
                        .HasColumnName("player_account_id");

                    b.Property<byte>("RegisteredPlayerCnt")
                        .HasColumnType("tinyint unsigned")
                        .HasColumnName("registered_player_cnt");
                    ...
                    b.HasKey("HomeLandId")
                        .HasName("pk_home_lands");

                    b.ToTable("home_lands", (string)null);
                });
